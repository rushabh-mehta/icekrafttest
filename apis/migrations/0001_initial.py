    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_fooditem_relation', models.ManyToManyField(to='apis.FoodItem')),
                ('order_restaurant_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apis.Restaurant')),
